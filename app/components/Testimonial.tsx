...
export default function Testimonial() {
  return (
    <div className="flex flex-col mt-24 justify-center items-center lg:px-0 tracking-tight">
      <h1 className="text-white text-4xl lg:text-8xl font-extrabold text-center">
      ...
      <div className="lg:grid lg:grid-cols-3 ">
        <div className="relative lg:px-24 p-12 flex flex-col text-center justify-center mt-12 lg:mt-24">
          ...
          />
          <p className="text-white border-[8px] p-8 text-sm rounded-2xl bg-gray-800/20 backdrop-blur-sm -z-10">
